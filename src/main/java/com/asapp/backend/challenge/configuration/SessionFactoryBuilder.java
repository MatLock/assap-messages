...
public class SessionFactoryBuilder {
  ...
  public static SessionFactory getSessionFractory(){
    if(sessionFactory == null){
      ...
      settings.setProperty("hibernate.connection.driver_class", "com.mysql.jdbc.Driver");
      settings.setProperty("hibernate.connection.url", "jdbc:mysql://localhost:3306/camp_site");
